...
module.exports = {
     ...
     * api Server
     */
    apiServer: process.env.NODE_ENV === 'production' ? 'http://v3.api.nownews.com:5000' : 'http://v3.api.nownews.com:5000',


    /*
     * V4 api Server
     */
    apiV4Server: process.env.NODE_ENV === 'production' ? 'https://v4api.nownews.com' : 'https://v4api.nownews.com',
